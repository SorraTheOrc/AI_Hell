...
- `src/scenes/PlayScene.ts` — wires the full loop: small asteroid kills drop minerals, player/enemy overlap collection, enemy re-drop on death, the HUD hold bar (a fixed-length outline that fills as the hold grows), and the hold-full choice.
